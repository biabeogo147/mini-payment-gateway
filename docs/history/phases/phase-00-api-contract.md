...
- Create: `docs/api/merchant.md`
- Create: `docs/api/ops.md`
- Create: `docs/api/provider-callback.md`
- Create: `docs/api/webhook.md`
- Create: `docs/api/errors.md`
- Modify: `docs/product/necessary-documents.md`
...
- [x] In `docs/api/merchant.md`, document `POST /v1/refunds`.
...
- [x] Create `docs/api/provider-callback.md`.
