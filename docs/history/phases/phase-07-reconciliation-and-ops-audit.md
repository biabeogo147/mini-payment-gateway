...
updates have been added. See `docs/history/completions/phase-07.md` for verification
...
Use `docs/testing/scenarios/merchant.md` as the behavior source for:
...
Use `docs/testing/scenarios/ops.md` as the behavior source for:
...
Use `docs/testing/scenarios/webhook.md` for the phase 06 manual retry behavior that
phase 07 will make auditable.

Use `docs/testing/matrix.md` to keep phase 07 test names aligned with
scenario IDs.
...
- Modify: `docs/testing/scenarios/merchant.md`
- Modify: `docs/testing/scenarios/ops.md`
- Modify: `docs/testing/scenarios/reconciliation.md`
- Modify: `docs/testing/matrix.md`
- Modify: `docs/history/README.md`
- Create: `docs/history/completions/phase-07.md`
...
- [ ] Update `docs/api/ops.md` with implemented request/response bodies.
- [ ] Update `docs/testing/scenarios/merchant.md`:
...
- [ ] Update `docs/history/README.md`:
  ...
  - add smoke command.
- [ ] Create `docs/history/completions/phase-07.md` with:
  - completed scope;
  - tests run;
  - smoke output;
