...
`docs/history/completions/phase-03-5.md`.

That slice documented the grouped end-to-end scenario catalog now archived under
`docs/testing/scenarios/`, including APIs, requests, responses, DB effects, state
