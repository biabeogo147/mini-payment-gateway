...
- Documented merchant auth headers, merchant payment API, merchant refund API,
  ...
  error shape.
- Updated `docs/product/necessary-documents.md` to point at the new API docs.
...
`docs/history/completions/phase-02-5.md`.
...
Proceed to `docs/history/phases/phase-03-payment-core.md`.
