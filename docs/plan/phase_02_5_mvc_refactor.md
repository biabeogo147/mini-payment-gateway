...
- Modify: `docs/plan/phase_03_payment_core.md`
...
- [x] Modify `docs/plan/phase_03_payment_core.md`.
...
```powershell
rg -n "app/api|api/routes|app\.api" docs/plan/phase_03_payment_core.md
```
...
- [x] Confirm `docs/architecture.md` describes the new layer order.
- [x] Confirm `docs/plan/README.md` lists phase 2.5 before phase 03.
- [x] Run:

```powershell
rg -n "API package boundaries|app/api|api/routes|app\.api" docs/plan docs/architecture.md
```
