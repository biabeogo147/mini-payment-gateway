...
Completion record: `docs/plan/phase_06_completion.md`.
...
Use `docs/api/webhook_spec.md` as the outbound webhook contract source.
...
- Modify: `docs/api/webhook_spec.md`
- Modify: `docs/plan/README.md`
- Modify: `docs/scenarios/callback.md`
- Modify: `docs/scenarios/e2e_scenarios.md`
- Modify: `docs/scenarios/happy_path.md`
- Modify: `docs/scenarios/refund.md`
- Modify: `docs/scenarios/testing_matrix.md`
- Modify: `docs/scenarios/webhook.md`
- Create: `docs/plan/phase_06_completion.md`
...
- [ ] Assert signing headers are present and `X-Webhook-Signature` matches the
  canonical string in `docs/api/webhook_spec.md`.
- [ ] Run:
...
- [ ] Update `docs/api/webhook_spec.md` if implementation fields differ from
  the contract above.
- [ ] Update `docs/api/ops_api.md` to note manual retry audit is phase 07.
- [ ] Update `docs/scenarios/webhook.md` statuses for implemented webhook
  scenarios.
- [ ] Update `docs/scenarios/callback.md` for phase 06 webhook event creation on
  payment success/failure/expiration.
- [ ] Update `docs/scenarios/refund.md` for phase 06 webhook event creation on
  refund success/failure.
- [ ] Update `docs/scenarios/happy_path.md` where webhook delivery steps become
  implemented with DB seed.
- [ ] Update `docs/scenarios/e2e_scenarios.md` current capability snapshot.
- [ ] Update `docs/scenarios/testing_matrix.md` phase 06 rows from `Planned` to
  implemented coverage.
- [ ] Update `docs/plan/README.md` standard verification commands with
  `scripts\smoke_webhook_api.py`.
- [ ] Create `docs/plan/phase_06_completion.md` with:
  - completed scope;
  - tests run;
  - smoke output;
