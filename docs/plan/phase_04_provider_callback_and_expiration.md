...
- [ ] Update `docs/scenarios/callback.md` statuses for implemented callback and
  expiration behavior.
- [ ] Update `docs/scenarios/reconciliation.md` for phase 04-owned
  reconciliation evidence creation.
- [ ] Update `docs/scenarios/testing_matrix.md` phase 04 rows from `Planned` to
  the exact implemented coverage.
- [ ] Create `docs/plan/phase_04_completion.md` after implementation.
