...
| Provider simulator | Provider callback API | Environment-local simulator trust in MVP | Callback payload references | `/v1/provider/callbacks/payment`, `/v1/provider/callbacks/refund` |
