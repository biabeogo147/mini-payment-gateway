...
scoped read APIs, a dedicated merchant-user account model, and internal provisioning
...
accept a client-supplied merchant identifier as the source of read scope after
login.
