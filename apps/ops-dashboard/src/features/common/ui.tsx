...
export function LoadingCard(props: { message?: string }) {
  return (
    <ContentCard>
      <div className="empty-state">
        <strong>Loading</strong>
        <p>{props.message ?? "Fetching live data from the ops API."}</p>
      </div>
    </ContentCard>
  );
}
